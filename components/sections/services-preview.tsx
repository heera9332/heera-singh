      ...
      <Container>
        <div className="text-center max-w-2xl mx-auto space-y-3 mb-14">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Transparent deliverables, fixed timelines, and high-quality engineering designed for startups, founders, and digital agencies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {featuredServices.map((service) => (
            <div
              key={service.id}
              className="flex flex-col justify-between rounded-2xl border border-border/80 bg-card/60 p-6 sm:p-8 transition-all hover:border-primary/50 hover:bg-card hover:shadow-xl hover:shadow-primary/5"
            >

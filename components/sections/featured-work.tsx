      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {featuredProjects.map((project) => (
            <ProjectCard key={project.slug} project={project} featuredLayout={true} />
          ))}
        </div>

        <div className="mt-12 p-8 rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/5 via-primary/10 to-transparent flex flex-col sm:flex-row items-center justify-between gap-6">

        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {clientProcess.map((step) => {
            ...
            return (
              <div
                key={step.step}
                className="relative flex flex-col justify-between rounded-2xl border border-border/80 bg-card/60 p-6 transition-all hover:border-primary/50 hover:bg-card"
              >

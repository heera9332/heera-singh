          ...
          <AnimateIn direction="up">
            <div className="max-w-3xl space-y-4">
              <Badge variant="orange" className="font-semibold text-xs">
                Freelance &amp; Mentorship Offerings
              </Badge>
              <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-foreground">
                Services &amp; Deliverables
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Transparent packages, fixed milestone timelines, and production-grade engineering tailored to startups, agencies, and students.
              </p>
            </div>
          </AnimateIn>
        </Container>
            ...
            {servicesData.map((service, index) => {
              ...
              return (
                <AnimateIn
                  ...
                  direction="up"
                >
                  <div className="rounded-3xl border border-border/80 bg-card/70 p-6 sm:p-10 space-y-8 shadow-sm transition-all hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5">
          ...
          <AnimateIn direction="up">
            <div className="rounded-3xl border border-primary/30 bg-card/80 p-8 sm:p-12 text-center space-y-6 max-w-4xl mx-auto shadow-xl shadow-primary/5">
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground">
                Need a tailored quote or custom scope?
              </h2>
              <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">
                Every project is unique. Let's schedule a 20-minute discovery call to review your specifications and map out milestones.
              </p>
